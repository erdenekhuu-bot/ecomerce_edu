...
class CartController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        if (Cookie::has('referred_product_id') && Cookie::get('referred_product_id') == $product_variation->product->id) {
        ...
        $membership_price = (float) variation_price($product_variation->product, $product_variation);
        $discount_price = (float) variation_discounted_price($product_variation->product, $product_variation);
        $user = auth('api')->user();
        if ($user) {
