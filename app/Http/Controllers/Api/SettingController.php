...
{
    public function home_setting($section, Upload $upload, Setting $setting)
    {
        switch ($section) {
            case 'background':
                $data = get_setting('background_swiper')
                    ? banner_array_generate(get_setting('background_swiper'), get_setting('background_swiper_link'))
                    : [];
                break;
            break;
            case 'sliders':
    ...
    public function footer_setting()
    {
        return Cache::remember('footer_setting', 86400, function () {
            return response()->json([
                ...
                'footer_background'=> get_setting('footer_background'),
                ...
                'footer_background'=>api_asset(get_setting('footer_background')),
                'footer_link_two' => [
