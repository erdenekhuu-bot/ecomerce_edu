...
class InvoiceController extends Controller
{
    ...
    public function invoice_quote_download($id)
    {
        if (session()->has('currency_code')) {
            $currency_code = session()->get('currency_code');
        } else {
        ...
        return PDF::loadView('backend.invoices.quote-invoice', [
            'order' => $order,
            'font_family' => $font_family,
            'direction' => $direction,
            'default_text_align' => $default_text_align,
            'reverse_text_align' => $reverse_text_align
        ], [], [])->download('order-' . $order->quote_no  . '.pdf');
    }
    ...
    public function invoice_quote_print($id)
    {
        if (session()->has('currency_code')) {
            $currency_code = session()->get('currency_code');
        } else {
        ...
        if ($order != null) {
            return view('backend.invoices.invoice_print_quote', compact('order', 'font_family', 'direction', 'default_text_align', 'reverse_text_align'));
        }
    }
}
