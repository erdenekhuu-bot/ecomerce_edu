...
if (!function_exists('filter_product_variations')) {
     ...
     */
    function filter_product_variations($variations, $product, $percent)
    {
        ...
        foreach ($variations as $variation) {
            ...
            $data['price'] = variation_discounted_price($product, $variation) - ((variation_discounted_price($product, $variation) / 100) * $percent);
            $data['guest_price'] = variation_discounted_price($product, $variation);
