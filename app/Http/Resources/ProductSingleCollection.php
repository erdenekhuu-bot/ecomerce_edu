...
{   
    ...
    public function toArray($request): Array
    {
        ...
        return [
            ...
            'for_pickup' => $this->for_pickup,
            'sku'=>$this->variations,  // ahaa details huudas deer sku haruulah gej ashiglaj bga bitgii ustgaarai ahaa...
            'review_summary' => [
            ...
            'variations' => filter_product_variations($this->variations,$this, $percent),
            ...
            'shop' => [
                ...
                'slug' => $this->shop->slug,
                'isVarified' => $this->shop->verification_status ==1 ? true : false,
            ],
            'earn_point' => (float) $this->earn_point,
            'is_digital' => $this->digital == 1 ? true : false,
            'factory_number' => (String) $this->factory_number,
        ];
    }
