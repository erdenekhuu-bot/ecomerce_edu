    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <div class="px-3 mb-3 position-relative">
                <input
                    class="form-control form-control-menu-search bg-transparent rounded-2 form-control-sm text-white fs-14 "
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                {{-- @canany(['pos_manager', 'pos_configuration'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <svg id="Group_22661" data-name="Group 22661" xmlns="http://www.w3.org/2000/svg" width="16"
                                height="18.563" viewBox="0 0 16 18.563">
                                <path id="Path_10" data-name="Path 10"
                                    d="M12.041,7H3.42A1.189,1.189,0,0,0,2.26,8.16V20.285A1.2,1.2,0,0,0,3.42,21.5h8.621a1.2,1.2,0,0,0,1.2-1.2V8.16A1.189,1.189,0,0,0,12.041,7ZM5.369,19.6h-1.1V18.5h1.1Zm0-2.732h-1.1v-1.1h1.1Zm0-2.732h-1.1v-1.1h1.1ZM8.27,19.6H7.179V18.5H8.287Zm0-2.732H7.179v-1.1H8.287Zm0-2.732H7.179v-1.1H8.287Zm2.9,5.465h-1.1V18.5h1.1Zm0-2.732h-1.1v-1.1h1.1Zm0-2.732h-1.1v-1.1h1.1Zm.377-3.481a.2.2,0,0,1-.191.2H4.087a.2.2,0,0,1-.191-.2V9.083a.191.191,0,0,1,.191-.191h7.3a.191.191,0,0,1,.191.191Zm5.906-1.682h-.261V19.519h.29a.777.777,0,0,0,.777-.777V9.756a.777.777,0,0,0-.806-.783Z"
                                    transform="translate(-2.26 -2.939)" fill="#707070" />
                                <rect id="Rectangle_10" data-name="Rectangle 10" width="1.7" height="10.552"
                                    transform="translate(11.516 6.033)" fill="#707070" />
                                <rect id="Rectangle_11" data-name="Rectangle 11" width="0.731" height="10.552"
                                    transform="translate(13.691 6.033)" fill="#707070" />
                                <path id="Path_11" data-name="Path 11"
                                    d="M14.971,1.038a1.033,1.033,0,0,0-.3-.737,1.056,1.056,0,0,0-.737-.3,1.038,1.038,0,0,0-1.056,1.038v.615h2.077Zm-2.553,0a.882.882,0,0,1,0-.168.789.789,0,0,1,0-.122h.012A.58.58,0,0,1,12.488.58a.5.5,0,0,1,.041-.116,1.387,1.387,0,0,1,.168-.3A.58.58,0,0,1,12.743.1l.081-.1h-4.7A.946.946,0,0,0,7.18.94V3.515H12.4Z"
                                    transform="translate(-4.326 0)" fill="#707070" />
                            </svg>
                            ...
                            @can('pos_manager')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('point-of-sales.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['point-of-sales.index', 'point-of-sales.create']) }}">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">Үнийн санал</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        {{-- <li class="aiz-side-nav-item">
                            <a href="{{ route('price-quote.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['price-quote.index']) }}">
                                <span class="aiz-side-nav-text">Үнийн санал үүсгэх</span>
                            </a>
                        </li> --}}
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('price-quote.list') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['price-quote.*']) }}">
                                <span class="aiz-side-nav-text">Үнийн саналын жагсаалт</span>
                            </a>
                        </li>
                    </ul>
                </li>
                                ...
                                @can('show_seller_products')
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <ul class="aiz-side-nav-list level-3">
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('admin.seller_products.index','physical') }}" class="aiz-side-nav-link">
                                                    <span class="aiz-side-nav-text">{{ translate('Physical Products') }}</span>

                                                </a>
                                            </li>
                                            <li class="aiz-side-nav-item">
                                                <a href="{{ route('admin.seller_products.index','digital') }}" class="aiz-side-nav-link">
                ...
                <!-- Order -->
                @if (addon_is_activated('multi_vendor') &&
                        (auth()->user()->can('show_orders') || auth()->user()->can('show_seller_orders')))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('show_orders')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('pickup.orders.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['pickup.orders.index']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Pickup Orders') }}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                    ...
                    @can('show_orders')
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('reports.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['reports.index', 'reports.show']) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 16 16">
                                    <path id="Subtraction_32" data-name="Subtraction 32"
                                        d="M15,16H1a1,1,0,0,1-1-1V1A1,1,0,0,1,1,0H15a1,1,0,0,1,1,1V15A1,1,0,0,1,15,16ZM7,11a1,1,0,1,0,0,2h6a1,1,0,0,0,0-2ZM3,11a1,1,0,1,0,1,1A1,1,0,0,0,3,11ZM7,7A1,1,0,1,0,7,9h6a1,1,0,0,0,0-2ZM3,7A1,1,0,1,0,4,8,1,1,0,0,0,3,7ZM7,3A1,1,0,1,0,7,5h6a1,1,0,0,0,0-2ZM3,3A1,1,0,1,0,4,4,1,1,0,0,0,3,3Z"
                ...
                @can('show_customers')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('membership.index') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['membership.index', 'membership.*']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14">
                                <g id="Group_8860" data-name="Group 8860" transform="translate(30 -252)">
                                    <path id="Rectangle_16218" data-name="Rectangle 16218"
                                        d="M4,0H6a4,4,0,0,1,4,4V7a0,0,0,0,1,0,0H1A1,1,0,0,1,0,6V4A4,4,0,0,1,4,0Z"
                            ...
                            <span class="aiz-side-nav-text">{{ translate('Memberships') }}</span>
                        </a>
                    </li>
                @endcan
                ...
                @if (addon_is_activated('multi_vendor'))
                    @canany(['show_sellers', 'show_payouts', 'show_payout_requests', 'show_commission_log', 'show_seller_packages', 'show_seller_package_payments', 'seller_verification_form'])
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12.444"
                ...
                @if (addon_is_activated('refund') &&
                        (auth()->user()->can('show_refund_requests') || auth()->user()->can('show_refund_settings')))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                        ...
                        <a href="#" class="aiz-side-nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14">
                                <g id="Group_8862" data-name="Group 8862" transform="translate(30 -303)">
                                    ...
                                    <rect id="Rectangle_16224" data-name="Rectangle 16224" width="2" height="12"
                                        rx="1" transform="translate(-19 303)" fill="#707070" />
                                </g>
                            </svg>
                ...
                @canany(['view_all_blogs', 'view_blog_categories'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <svg id="Group_23438" data-name="Group 23438" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="14.282"
                                viewBox="0 0 16 14.282">
                                <defs>
                                    <clipPath id="clip-path">
                                        <rect id="Rectangle_17256" data-name="Rectangle 17256" width="16"
                                            height="14.282" fill="#707070" />
                                    </clipPath>
                                </defs>
                                <g id="Group_23436" data-name="Group 23436" clip-path="url(#clip-path)">
                                    <path id="Path_28779" data-name="Path 28779"
                                        d="M13.746,85.891v.233q0,3.012,0,6.024a1.588,1.588,0,0,1-1.691,1.687H1.813a1.591,1.591,0,0,1-1.7-1.7q0-3.9,0-7.809v-.214H9.994c-.064.069-.111.122-.161.172Q8.055,86.064,6.275,87.84a2,2,0,0,0-.569,1.027c-.17.785-.359,1.566-.54,2.348-.1.414.074.586.486.491.789-.182,1.577-.371,2.368-.544A1.985,1.985,0,0,0,9.029,90.6q2.26-2.272,4.53-4.534c.051-.051.1-.1.187-.176"
                                        transform="translate(-0.109 -79.554)" fill="#707070" />
                                    <path id="Path_28780" data-name="Path 28780"
                                        d="M.013,3.884c0-.83-.035-1.648.01-2.462A1.537,1.537,0,0,1,1.577,0Q6.83,0,12.082,0a1.522,1.522,0,0,1,1.335.787.2.2,0,0,1-.042.293c-.907.9-1.808,1.806-2.715,2.705a.357.357,0,0,1-.224.1Q5.265,3.9.094,3.895a.805.805,0,0,1-.081-.011M1.953,2.6c.115,0,.23.008.345,0a.319.319,0,0,0,.3-.321.314.314,0,0,0-.3-.32c-.229-.011-.46-.011-.689,0a.313.313,0,0,0-.3.32.319.319,0,0,0,.3.321c.114.01.23,0,.345,0m1.954,0c.108,0,.217.006.324,0a.321.321,0,0,0,.317-.329.316.316,0,0,0-.309-.314c-.223-.01-.446-.009-.669,0a.316.316,0,0,0-.316.328.32.32,0,0,0,.309.315c.114.009.23,0,.345,0m1.934,0c.115,0,.23.007.345,0A.32.32,0,0,0,6.5,2.28a.317.317,0,0,0-.316-.328c-.223-.009-.446-.009-.669,0a.315.315,0,0,0-.31.313.321.321,0,0,0,.316.329c.108.008.216,0,.324,0"
                                        transform="translate(0 0)" fill="#707070" />
                                    <path id="Path_28781" data-name="Path 28781"
                                        d="M106.691,54.778c.114-.5.216-.963.327-1.427.26-1.087.1-.821.92-1.644q2.864-2.869,5.733-5.734c.047-.047.1-.091.133-.125l1.829,1.829c-.038.04-.087.095-.139.146q-3.053,3.053-6.1,6.108a1.461,1.461,0,0,1-.746.417c-.586.128-1.17.268-1.755.4-.051.012-.1.014-.2.027"
                                        transform="translate(-100.909 -43.363)" fill="#707070" />
                                    <path id="Path_28782" data-name="Path 28782"
                                        d="M247.2,23.2c.217-.215.44-.449.676-.668a.317.317,0,0,1,.457.015q.686.674,1.36,1.359a.3.3,0,0,1,.014.453c-.182.2-.378.385-.569.576-.037.037-.078.072-.106.1L247.2,23.2"
                                        transform="translate(-233.799 -21.222)" fill="#707070" />
                                </g>
                            </svg>
                            ...
                            @can('view_blog_categories')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('blog-category.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['blog-category.edit']) }}">
                ...
                @canany(['affiliate_configuration', 'show_affiliate_users', 'show_referral_users',
                    'affiliate_withdraw_request', 'affiliate_log'])
                    @if (get_setting('affiliate_system') == 1)
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <svg id="Group_23794" data-name="Group 23794" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g id="Group_23782" data-name="Group 23782" clip-path="url(#clip-path)">
                                        <path id="Path_27903" data-name="Path 27903"
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endcan
                                @can('affiliate_withdraw_request')
                                    <li class="aiz-side-nav-item">
                ...
                <!-- Delivery Boy System -->
                @canany(['view_all_delivery_boy', 'add_delivery_boy', 'delivery_boy_payment_histories',
                    'delivery_boy_cancel_request_list', 'delivery_boy_configuration', 'delivery_boy_collection_histories'])
                    @if (get_setting('delivery_boy') == 1)
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16.979" height="17.412"
                                    viewBox="0 0 16.979 17.412">
                                    <g id="Group_28381" data-name="Group 28381" transform="translate(0 0.002)">
                                        <path id="Path_28049" data-name="Path 28049"
                                            d="M326.059,437.512a1.12,1.12,0,1,1-2.236,0h-1.355a2.474,2.474,0,1,0,4.946,0Zm0,0"
                                            transform="translate(-311.501 -422.635)" fill="#707070" />
                                        <path id="Path_28050" data-name="Path 28050"
                                            d="M385.314,437.512H384.6a.361.361,0,1,0,.712,0Zm0,0"
                                            transform="translate(-371.517 -422.635)" fill="#707070" />
                                        <path id="Path_28051" data-name="Path 28051"
                                            d="M93.6,437.512H92.89a.361.361,0,1,0,.712,0Zm0,0"
                                            transform="translate(-89.726 -422.635)" fill="#707070" />
                                        <path id="Path_28052" data-name="Path 28052"
                                            d="M35.415,437.512a1.12,1.12,0,1,1-2.236,0H31.824a2.474,2.474,0,1,0,4.946,0Zm0,0"
                                            transform="translate(-30.741 -422.635)" fill="#707070" />
                                        <path id="Path_28053" data-name="Path 28053"
                                            d="M363.886,164.478l-2.23-5.049a1.333,1.333,0,0,0-2.476.081l1.125.068a1.236,1.236,0,0,1-.149,2.467l-.519-.031q.019.141.031.283a1.261,1.261,0,0,1,.312,1.635l-.126.211-.011.018a3.48,3.48,0,0,1,3.32,1.285.695.695,0,0,0,.722-.969Zm0,0"
                                            transform="translate(-346.964 -153.236)" fill="#707070" />
                                        <path id="Path_28054" data-name="Path 28054"
                                            d="M321.125,335.02a2.966,2.966,0,0,0-.947.154L318.5,337.99h5.258a.319.319,0,0,0,.316-.359A2.971,2.971,0,0,0,321.125,335.02Zm0,0"
                                            transform="translate(-307.668 -323.628)" fill="#707070" />
                                        <path id="Path_28055" data-name="Path 28055"
                                            d="M213.713,0a1.6,1.6,0,1,0,1.478,1.7A1.6,1.6,0,0,0,213.713,0Zm0,0"
                                            transform="translate(-204.795 0)" fill="#707070" />
                                        <path id="Path_28056" data-name="Path 28056"
                                            d="M13.309,117.931l-2.653-.16L9.176,116.23l1.516,1.029.84.051a2.014,2.014,0,0,1,.264-.6l-.546.266-.906-.733a1.077,1.077,0,0,0-1-1.124l-1.829-.13a1.078,1.078,0,0,0-1.154,1.083l.04,5.237H5.867v-4.67a.674.674,0,0,0-.674-.674H.674a.674.674,0,0,0-.674.674V121.9a.674.674,0,0,0,.674.674h1.57v.157A2.973,2.973,0,0,0,.518,125.08a.319.319,0,0,0,.316.36H6.1a.319.319,0,0,0,.316-.36,2.944,2.944,0,0,0-.058-.321H7.921l1.723-2.892-1.167-.538,1.851.478-2.074,3.481a.867.867,0,1,0,1.49.888l2.666-4.476a.867.867,0,0,0-.528-1.284l-2.972-.767.856-.028a.764.764,0,0,1-.327-.289l-1.307-2.1,1.677,1.744a.723.723,0,0,0,.477.221c3.109.187,2.937.179,2.979.179a.723.723,0,0,0,.043-1.444Zm-8.472.4H1.03v-1.336H4.837Zm0,0"
                                            transform="translate(0 -111.077)" fill="#707070" />
                                    </g>
                                </svg>
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                @can('view_all_delivery_boy')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('delivery-boy.index') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['delivery-boy.index', 'delivery-boy.edit']) }}">
                                ...
                                @can('add_delivery_boy')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('delivery-boy.create') }}" class="aiz-side-nav-link">
                                ...
                                @can('delivery_boy_configuration')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('delivery-boy.configuration') }}" class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text">{{ translate('Delivery Boy Configurations') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('delivery_boy_cancel_request_list')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('delivery-boy.cancel_request_list') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Cancel Request') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('delivery_boy_payment_histories')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('delivery-boy.payment_histories') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Payment Histories') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('delivery_boy_collection_histories')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('delivery-boy.collection_histories') }}"
                                            class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Collections Histories') }}</span>
                                        </a>
                                    </li>
                                @endcan
                ...
                <!-- club points System -->
                @canany(['club_point_configuration', 'show_user_points'])
                            ...
                            <a href="#" class="aiz-side-nav-link">
                                <svg id="Group_22520" data-name="Group 22520" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g id="Group_22519" data-name="Group 22519" clip-path="url(#clip-path)">
                                        <path id="Path_27921" data-name="Path 27921"
                                        ...
                                        <path id="Path_27922" data-name="Path 27922"
                                            d="M153.3,53.949c0,.54.005,1.081-.007,1.622,0,.065-.088.146-.155.188a4.946,4.946,0,0,1-1.6.6,13.584,13.584,0,0,1-5.454.138.311.311,0,0,0-.4.217.3.3,0,0,0,.276.374,12.975,12.975,0,0,0,3.131.209,12.576,12.576,0,0,0,3.225-.52c.329-.1.646-.243.989-.373v.2c0,1.232-.006,2.464.006,3.7a.43.43,0,0,1-.257.456,10.081,10.081,0,0,1-1.317.512,13.242,13.242,0,0,1-4.4.34.508.508,0,0,1-.068-.01l-.481-1.9c.192.015.42.033.647.049a13.885,13.885,0,0,0,3.454-.171c.237-.043.345-.156.333-.338s-.165-.292-.4-.268c-.671.071-1.342.18-2.015.191-.749.012-1.5-.069-2.249-.109a.36.36,0,0,1-.3-.184,5.643,5.643,0,0,0-2.5-2.1c-.086-.037-.164-.06-.162-.193.008-.859,0-1.719,0-2.578a.331.331,0,0,1,.012-.059,5.839,5.839,0,0,0,3.279,1.12,13.6,13.6,0,0,0,4.076-.139,5.737,5.737,0,0,0,1.687-.545c.224-.121.427-.28.653-.431m-8.1,2.982a1.151,1.151,0,0,0,.247-.256.248.248,0,0,0-.121-.34,2.272,2.272,0,0,0-.477-.176.271.271,0,0,0-.32.177.251.251,0,0,0,.081.338,5.5,5.5,0,0,0,.589.258m7.19,1.99a.3.3,0,0,0-.385-.279,2.355,2.355,0,0,0-.408.146.292.292,0,0,0-.107.46c.168.2.356.088.538.026s.354-.121.362-.354"
                                            transform="translate(-136.315 -51.21)" fill="#707070" />
                                        <path id="Path_27923" data-name="Path 27923"
                                            d="M153.954,9.585a9.754,9.754,0,0,1-3.219-.5,3.168,3.168,0,0,1-.809-.44.776.776,0,0,1,0-1.326,3.408,3.408,0,0,1,1.448-.624,11.861,11.861,0,0,1,5.774.089,3.7,3.7,0,0,1,1.088.508.791.791,0,0,1,0,1.406,4.18,4.18,0,0,1-1.7.657,12.532,12.532,0,0,1-2.583.232"
                                            transform="translate(-141.977 -6.057)" fill="#707070" />
                                        <path id="Path_27924" data-name="Path 27924"
                                            d="M169.215,252.617c.234-.21.451-.393.654-.591a5.326,5.326,0,0,0,1.008-1.366.175.175,0,0,1,.2-.116,14.607,14.607,0,0,0,3.2.038,10.142,10.142,0,0,0,2.828-.573c.169-.066.331-.15.513-.234,0,.063.01.116.01.169,0,.442-.012.885,0,1.326a.948.948,0,0,1-.473.91,5.278,5.278,0,0,1-1.108.515,11.772,11.772,0,0,1-3.975.409,10.789,10.789,0,0,1-2.467-.363c-.127-.036-.252-.079-.394-.123"
                                            transform="translate(-160.643 -237.121)" fill="#707070" />
                                        <path id="Path_27925" data-name="Path 27925"
                                            d="M209.464,202.985l.344-1.815a12.908,12.908,0,0,0,6.029-.87c0,.54.007,1.081-.007,1.622a.328.328,0,0,1-.162.232,6.555,6.555,0,0,1-1.119.491,14.108,14.108,0,0,1-5.054.351.063.063,0,0,1-.03-.011"
                                            transform="translate(-198.853 -190.153)" fill="#707070" />
                                        <path id="Path_27926" data-name="Path 27926"
                                            d="M58.35,2.409q0,1,0,2.007c0,.242-.109.38-.3.382s-.308-.14-.309-.375q0-2.026,0-4.052c0-.233.125-.375.311-.372s.293.137.294.365c0,.682,0,1.363,0,2.045"
                                            transform="translate(-54.818 0)" fill="#707070" />
                                        <path id="Path_27927" data-name="Path 27927"
                                            d="M14.531,57.949c0,.4,0,.809,0,1.213,0,.211-.1.332-.27.353-.192.023-.332-.113-.333-.342,0-.594,0-1.188,0-1.782,0-.221,0-.442,0-.663s.113-.363.295-.367.308.138.31.374c0,.4,0,.809,0,1.213"
                                            transform="translate(-13.218 -53.507)" fill="#707070" />
                                        <path id="Path_27928" data-name="Path 27928"
                                            d="M101.74,42.721c0-.328,0-.655,0-.983,0-.218.125-.357.307-.353a.312.312,0,0,1,.3.345q0,1,0,2a.313.313,0,0,1-.309.352c-.182,0-.295-.14-.3-.364,0-.334,0-.668,0-1"
                                            transform="translate(-96.586 -39.289)" fill="#707070" />
                                        <path id="Path_27929" data-name="Path 27929"
                                            d="M13.934,11.365c0-.176-.006-.353,0-.528a.3.3,0,1,1,.6-.008q.015.547,0,1.094a.3.3,0,1,1-.6-.011c-.007-.182,0-.365,0-.547"
                                            transform="translate(-13.226 -9.997)" fill="#707070" />
                                        <path id="Path_27930" data-name="Path 27930"
                                            d="M101.687,19.024c0-.229.083-.355.251-.382a.3.3,0,0,1,.344.226.428.428,0,0,1-.162.516.312.312,0,0,1-.433-.36"
                                            transform="translate(-96.533 -17.693)" fill="#707070" />
                                    </g>
                                </svg>
                        ...
                        <a href="#" class="aiz-side-nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14">
                                <g id="Group_8864" data-name="Group 8864" transform="translate(-24 -40)">
                                    <rect id="Rectangle_16227" data-name="Rectangle 16227" width="16" height="11"
                                        rx="1" transform="translate(24 40)" fill="#707070" />
                ...
                @canany(['show_shop_setting', 'show_general_setting', 'sms_settings', 'show_languages',
                    'show_currencies', 'smtp_setting', 'payment_method', 'file_system', 'social_media_login',
                    'third_party_setting', 'shipping_configuration', 'show_taxes'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            @can('shipping_configuration')
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('pickup-point.index') }}"
                                                class="aiz-side-nav-link {{ areActiveRoutes(['pickup-point.index', 'pickup-point.create', 'pickup-point.edit', 'pickup-point.update']) }}">
