...
<body>
    <div>
        ...
        <div style="margin:8px 8px 15px 8px; display:flex;justify-content: space-between;">
        ...
        <div
            style="margin:0 8px;border:1px solid #DEDEDE;border-radius:3px;padding:0 7px; clear:both;mnargin-top:15px;">
            <table class="padding">
                <thead>
                    <tr>
