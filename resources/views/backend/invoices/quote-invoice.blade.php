                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="">
                                            ...
                                            <span class="bold" style="color: #ED2939">{{ $order->quote_no }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="">
                                            <span class=" ">{{ translate('Order Date') }}:</span>
                                            <span class="bold">{{ $order->created_at->format('d.m.Y') }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <span class="bold"
                                                style="text-transform: capitalize">{{ translate($order->type_of_delivery == 'pickup' ? $order->type_of_delivery : $order->delivery_type) }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div style="padding:10px 14px; border:1px solid #DEDEDE;border-radius:3px;width:45%;float:left;">
                    <table class="">
                        <tbody>
                            ...
                            <tr>
                                <td class="bold">{{ translate('Pick Up Point') }}:</td>
                            </tr>
                            <tr>
                                <td class="">{{ $pickup_address?->name }}</td>
                            </tr>
                            <tr>
                                <td class="">{{ translate('Manager') }}: {{ $pickup_address?->user?->name }}
                                </td>

                            </tr>
                            <tr>
                                <td class="">{{ $pickup_address?->location }}</td>
                            </tr>

                            <tr>
                                <td class="">{{ translate('Phone') }}: {{ $pickup_address?->phone }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
