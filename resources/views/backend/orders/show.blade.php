...
@section('content')
    ...
    <div class="row gutters-5">
        <div class="col-lg">
                        ...
                        <div class="col-md-3 mr-auto ml-0">
                            ...
                            @if (get_setting('delivery_boy') == 1)
                                <div class="mb-3">
                                    ...
                                    @if (
                                        ($order->delivery_status == 'pending' || $order->delivery_status == 'confirmed' || $order->delivery_status == 'picked_up') )
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="fs-16 mb-0">{{ 'Тэмдэглэл' }}</h3>
                    
                </div>
                <div class="card-body">
                    <form action="{{ route('orders.update_note') }}" method="POST">
                        @csrf
                        <div><textarea name="note" class="form-control" style="width: 100%" rows="10">{{ $order->note }}</textarea></div>
                        <input type="hidden" name="order_id" value="{{ $order->id }}">
                        <button type="submit" class="btn btn-success mt-2" style="float: right">Шинэчлэх</button>
                    </form>
                </div>
            </div>
