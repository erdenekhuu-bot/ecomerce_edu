            ...
            <div class="modal-content" id="variants">
                ...
                <div class="modal-footer">
                    ...
                    if (Session::get('pos.shipping_info')) {
                        $wallet_active_check = Session::get('pos.shipping_info')['wallet_amount'] > single_price($subtotal+$tax+Session::get('pos.shipping', 0) - Session::get('pos.discount', 0)) ? true : false;
                    }
                    @endphp
                    <button type="button" onclick="submitOrder('wallet')" class="btn btn-base-1 btn-primary" @if(Session::get('pos.shipping_info') && $wallet_active_check == false) disabled @endif>{{translate('Confirm with Wallet')}}</button>
