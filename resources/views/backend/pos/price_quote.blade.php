                            ...
                            <div class="" id="cart-details">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            @forelse (Session::get('pos.cart') as $key => $cartItem)
                                                @php
                                                    ...
                                                    $product_variation = \App\Models\ProductVariation::find(
                                                ...
                                                <li class="list-group-item py-3 px-0">
                                                    <div class="row gutters-15 align-items-center">
                                                        <div class="col-auto w-60px px-0">
                                                            <div
                                                                class="row ml--10 align-items-center flex-column aiz-plus-minus">
                                                                <button
                                                                    class="btn btn-icon btn-soft-dark col-auto btn-sm fs-15 hw-32px"
                                                                ...
                                                                <input type="text" name="qty-{{ $key }}"
                                                                    id="qty-{{ $key }}"
                                                                    class="col border-0 text-center flex-grow-1 fs-16 input-number py-1"
                                                                    placeholder="1" value="{{ $cartItem['quantity'] }}"
                                                                    min="{{ $product_variation->product->min_qty }}"
                                                                    max="100000"
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between fw-600 mb-2 opacity-70">
                                        ...
                                        <span>{{ Session::get('pos.discount_type') == '₮' ? single_price(Session::get('pos.discount', 0)) : Session::get('pos.discount', 0) . Session::get('pos.discount_type') }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between fw-600 fs-18 border-top py-3">
                                        <span>{{ translate('Total') }}</span>
                                        <span>{{ Session::get('pos.discount_type') == '₮' ? single_price($subtotal + $tax + Session::get('pos.shipping', 0) - Session::get('pos.discount', 0)) : single_price($subtotal + $tax + Session::get('pos.shipping', 0) - (($subtotal + $tax + Session::get('pos.shipping', 0)) * (Session::get('pos.discount', 0) / 100))) }}</span>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="dropdown dropup">
                                            ...
                                            <div class="dropdown-menu p-3 dropdown-menu-lg discount-popover">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <span id="radioLabel" class="input-group-text"
                                                            onclick="setDiscount()">₮</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal-footer">
                    ...
                    @php
                        ...
                        if (Session::get('pos.shipping_info')) {
                            $wallet_active_check =
                                Session::get('pos.shipping_info')['wallet_amount'] >
                                single_price(
                                    $subtotal +
                                        $tax +
                                        Session::get('pos.shipping', 0) -
...
@section('script')
    <script type="text/javascript">
        ...
        radioLabel.addEventListener("click", () => {
            // Toggle value
            const currentValue = radioLabel.textContent === "₮";
            radioLabel.textContent = currentValue ? "%" : "₮";
            discount_type= currentValue ? "%" : "₮";
        });
        var products = null;
        ...
        $(document).ready(function() {
            ...
            $('#product-list').on('click', '.add-plus:not(.c-not-allowed)', function() {
                ...
                $.post('{{ route('pos.addToCart') }}', {
                    ...
                    product_variation_combination_id: product_variation_combination_id,
