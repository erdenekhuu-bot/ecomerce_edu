        ...
        <form class="" id="sort_orders" action="" method="GET">
            <div class="card-header row gutters-5">
                <div class="col text-center text-md-left">
                    <h5 class="mb-md-0 h6">Үнийн санал</h5>
                </div>
                ...
                <table class="table aiz-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="lg">Төлөв</th>
                    ...
                    <tbody>
                        @foreach ($orders as $key => $order)
                            <tr>
                                ...
                                @endif
                                <td>
                                    <div class="fw-600">{{ $order->quote_no ?? '' }}</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    @if ($order->quote_status == 'admin_send')
                                        <span class="badge badge-inline badge-success">Админ илгээсэн</span>
                                    @elseif($order->quote_status == 'admin_change')
                                        <span class="badge badge-inline badge-success">Админаас хариу өгсөн</span>
                                    @else
                                        <span class="badge badge-inline badge-warning">Хэрэглэгч илгээсэн</span>
                                    @endif
                                </td>
                                <td>
                                    {{ $order->saler->name ?? "Сонгоогүй" }}
                                </td>
                                <td class="text-right">
                                    
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                        href="{{ route('price-quote.show', $order->id) }}"
                                        ...
                                        <a class="btn btn-soft-success btn-icon btn-circle btn-sm"
                                            ...
                                            onclick="print_invoice('{{ route('quote.invoice.print', $order->id) }}')">
                                            <i class="las la-print"></i>
                                        </a>
                                        <a class="btn btn-soft-info btn-icon btn-circle btn-sm"
                                            href="{{ route('quote.invoice.download', $order->id) }}"
