                        ...
                        <form  method="POST" action="{{route('brands.store')}}">
                            ...
                            <div class="form-group mb-3">
                             ...
                             <div class="form-group mb-3">
                                ...
                                <div class="">
                                    <textarea name="meta_description" rows="5" class="form-control" placeholder="{{ translate('Meta Description') }}">{{old('meta_description')}}</textarea>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Детал зураг')}}</label>
                                <div class="col-md-9">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                        <div class="input-group-prepend">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input type="hidden" name="additional_description" value="{{$brand->additional_description ?? ''}}" class="selected-files">
                                    </div>
                                    <div class="file-preview box sm">
                                    </div>
                                </div>
