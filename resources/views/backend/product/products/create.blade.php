    ...
    <form class="form form-horizontal mar-top" action="{{ route('product.store') }}" method="POST"
        ...
        <div class="row gutters-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" data-live-search="true" name="product_status"
                                    ...
                                    <option value="by_order">Захиалгаар</option>
                                    <option value="coming">Ирж байгаа</option>
                                </select>
                            </div>
                            
                        </div>
                        <!-- Hidden input field -->
                        <div id="byOrderInputContainer" style="display: none; margin-top: 10px;">
                            <label for="orderDetails">Захиалгын дэлгэрэнгүй:</label>
                            <input type="text" class="form-control" id="orderDetails" name="order_detail" placeholder="Захиалгын дэлгэрэнгүй оруулна уу">
                        </div>
                    </div>
                </div>
                <div class="card">
                        ...
                        <div class="no_product_variant">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" step="0.01" min="0"
                                        placeholder="{{ translate('Regular price') }}" name="price" class="form-control"
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Current Stock') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" name="current_stock" class="form-control" min="0">
                                </div>
                            </div>
                        </div>
            ...
            <div class="col col-lg-auto w-lg-300px w-xxl-400px">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Youtube Iframe</h5>
                    </div>
                    <div class="card-body">
