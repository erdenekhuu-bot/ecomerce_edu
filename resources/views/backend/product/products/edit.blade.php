    ...
    <form class="form form-horizontal mar-top" action="{{ route('product.update', $product->id) }}" method="POST"
        ...
        <div class="row gutters-5">
            <div class="col-lg">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Factory Number') }} </label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="factory_number"
                                    placeholder="Factory Number"
                                    value="{{ $product->factory_number }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Product Status') }}</label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" data-live-search="true" name="product_status"
                                            data-minimum-results-for-search="Infinity" id="assign_deliver_boy">
                                    <option value="ready" {{$product->product_status == "ready" ? "selected" : ""}}>Бэлэн байгаа</option>
                                    <option value="by_order" {{$product->product_status == "by_order" ? "selected" : ""}}>Захиалгаар</option>
                                    <option value="coming" {{$product->product_status == "coming" ? "selected" : ""}}>Ирж байгаа</option>
                                </select>
                            </div>
                        </div>
                        <!-- Hidden input field -->
                        <div class="form-group row" id="byOrderInputContainer" style="{{$product->product_status == "by_order" || $product->product_status == "coming" ? "" : "display: none;"}} margin-top: 10px;">
                            <label class="col-md-3 col-from-label" for="orderDetails">Захиалгын дэлгэрэнгүй:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="orderDetails" name="order_detail" value="{{$product->order_detail}}" placeholder="Захиалгын дэлгэрэнгүй оруулна уу">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col col-lg-auto w-lg-300px w-xxl-400px">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Product Special</h5>
                    </div>
                    <div class="card-body">
                        <select class="form-control aiz-selectpicker" name="special" data-live-search="true"
                            title="{{ translate('Product Special') }}">
                            <option value="0">Шинээр ирсэн</option>
                            <option value="1">Онцгой санал</option>
                            <option value="2">Хямдрал</option>
                        </select>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Youtube URL</h5>
                    </div>
                    <div class="card-body">
                        <input type="text" class="form-control" name="youtube" placeholder="{{ translate('Youtube URL') }}">
                    </div>
                </div>
                <div class="card">
                    <div class="card-header">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('#assign_deliver_boy').change(function () {
            const selectedValue = $(this).val(); // Get the selected value
            
            if (selectedValue === 'by_order' || selectedValue === 'coming') {
                $('#byOrderInputContainer').show(); // Show the input field
            } else {
                $('#byOrderInputContainer').hide(); // Hide the input field
            }
        });
