...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/price-quote', [PriceQuoteController::class, 'index'])->name('price-quote.index');
    Route::get('/price-quote-list', [PriceQuoteController::class, 'quoteList'])->name('price-quote.list');
    Route::get('/price-quote/{id}', [PriceQuoteController::class, 'quoteShow'])->name('price-quote.show');
    Route::post('/price-quote', [PriceQuoteController::class, 'order_store_quote'])->name('price-quote.store');
    Route::get('/price-quote/invoice/{order_id}', [InvoiceController::class, 'invoice_quote_download'])->name('quote.invoice.download');
    Route::get('/price-quote/print/{order_id}', [InvoiceController::class, 'invoice_quote_print'])->name('quote.invoice.print');
    Route::post('/price-quote/update-status/{id}', [PriceQuoteController::class, 'update_status'])->name('price-quote.update.status');
    ...
    Route::group(['prefix' => 'memberships',], function () {
        ...
        Route::post('/update/{id}', [MembershipController::class, 'update'])->name('membership.update');
        Route::get('/destroy/{id}', [MembershipController::class, 'destroy'])->name('membership.destroy');
    });

    Route::group(['prefix' => 'reports',], function () {
        Route::get('/', [OrderController::class, 'report_index'])->name('reports.index');
        Route::get('/show/{id}', [OrderController::class, 'report_show'])->name('reports.show');
        Route::get('/export', [OrderController::class, 'export'])->name('reports.export');
    });
    ...
    Route::post('/orders/update_note', [OrderController::class, 'update_note'])->name('orders.update_note');
