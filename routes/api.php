...
use App\Http\Controllers\SwipperBackground;
use App\Http\Controllers\GolomtController;
...
Route::group(['prefix' => 'v1', 'as' => 'api.'], function () {
    ...
    Route::group(['middleware' => ['auth:api', 'unbanned']], function () {
        ...
        Route::group(['prefix' => 'user'], function () {
            ...
            Route::get('users_list', [UserController::class, 'userList']);
            ...
            Route::get('quotes', [OrderController::class, 'quoteIndex']);
            Route::get('quote/{order_code}', [OrderController::class, 'quoteShow']);
            ...
            Route::post('quote_order/{code}/store', [OrderController::class, 'quoteStore']);
            Route::post('quote/quote-order/create', [OrderController::class, 'quoteCreate']);
            ...
            Route::post('/wallet/isPaid/{id}', [QpayController::class , 'isPaidWallet']);
            Route::post('/order/isPaid/{id}', [QpayController::class , 'isPaidOrder']);
            Route::get('/golomt/isPaid/{id}', [GolomtController::class , 'isPaid']);
        });
    ...
    Route::group(['prefix'=>'background'], function(){
        Route::get('/', [SwipperBackground::class, 'index']);
    });
});
