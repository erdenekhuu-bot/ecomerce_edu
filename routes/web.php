...
Route::get('/test-data', [QpayController::class , 'test']);
Route::get('/qpay/combined-order/webhook', [QpayController::class , 'webhook']);
Route::get('/qpay/wallet/webhook', [QpayController::class , 'webhookWallet']);
