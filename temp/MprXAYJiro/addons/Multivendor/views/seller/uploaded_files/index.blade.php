...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		...
		<div class="col-md-6 text-md-right">
			<a href="{{ route('seller.uploaded_files.create') }}" class="btn btn-primary">
    				...
    				<div class="aiz-file-box">
    					<div class="dropdown-file" >
    						...
    						<div class="dropdown-menu dropdown-menu-right">
    							...
    							<a href="javascript:void(0)" class="dropdown-item confirm-alert" data-href="{{ route('seller.uploaded-files.destroy', $file->id ) }}" data-target="#delete-modal">
...
@section('script')
	<script type="text/javascript">
		function detailsInfo(e){
			...
			$.post('{{ route('seller.uploaded-files.info') }}', {_token: AIZ.data.csrf, id:id}, function(data){
